...
class Authorization:
    ...
    owner_ids = [1083535720511197326, 1114957083025096724, 1108907120788787243, 1122568920591769650, 1086130070743162940, 433808798692409347, 485222547944767510] 
    
    class database:
      host = 'db.izieigfmxfkcqkqxgoac.supabase.co'
      password = 'honoredbot1002'
      database = 'postgres'
      user = 'postgres'
      port: int = 5432
